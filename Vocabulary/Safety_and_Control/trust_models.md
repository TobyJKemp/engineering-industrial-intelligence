...
Trust models are like **airline crew hierarchy and trust:**

- **Pilot-in-Command (Captain):** Highest trust level—can make autonomous decisions; other crew executes
- **Co-pilot:** High trust with checking—makes decisions but Captain verifies critical ones
- **Flight Attendants:** Moderate trust—autonomous on routine service; escalate emergencies to pilots
- **Maintenance Crew:** High trust in their domain—can service aircraft; but components are X-rayed/tested
- **New crew member:** Low trust initially—supervised, paired with experienced crew; trust grows over time

Each role has calibrated trust based on competence, stakes, and track record. If someone makes a major error, trust decreases (they move to lower-trust role). If someone consistently performs excellently, trust increases (more autonomy given).
...
**Builds On:**
- [Organizational Governance](../Organizational_Governance/organizational_governance.md)—governance enables trust
- [Authority Structures](../Organizational_Governance/authority_structures.md)—trust determines authority distribution
- [Accountability Systems](../Organizational_Governance/accountability_systems.md)—verification and consequences support trust
